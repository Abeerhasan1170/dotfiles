...
if exists("syntax_on")
  ...
  hi Visual cterm=reverse ctermbg=NONE gui=reverse guifg=Grey80 guibg=NONE
  ...
  hi MatchParen term=underline cterm=underline ctermbg=NONE ctermfg=NONE
  ...
  " hi Error term=reverse cterm=bold ctermfg=7 ctermbg=1 gui=bold guifg=White
  " guibg=Red
